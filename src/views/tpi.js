...
const TPI = (props) => {
  return (
    <div className="tpi-container1">
      ...
      <a href="https://play.teleporthq.io/signup" className="tpi-link">
        <div aria-label="Sign up to TeleportHQ" className="tpi-container2">
          <svg
            width="24"
            height="24"
            viewBox="0 0 19 21"
          ...
          <span className="tpi-text">Built in TeleportHQ</span>
        </div>
      </a>
    </div>
  )
