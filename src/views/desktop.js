    ...
    <div className="desktop-container1">
      ...
      <div className="desktop-thq-desktop-elm">
        <div className="desktop-thq-hero1-elm">
          ...
          <img
            src="/deviceframe317-u3t-1400w.png"
            className="desktop-thq-deviceframe-elm"
          />
        </div>
      ...
      <a href="https://play.teleporthq.io/signup" className="desktop-link">
        <div aria-label="Sign up to TeleportHQ" className="desktop-container2">
          <svg
            width="24"
            height="24"
            viewBox="0 0 19 21"
          ...
          <span className="desktop-text3">Built in TeleportHQ</span>
        </div>
      </a>
    </div>
  );
